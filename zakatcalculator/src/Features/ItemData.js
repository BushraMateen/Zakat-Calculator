export const items = [
    ...
    {Line : 6, category: 'Business Wealth', AmtVal: '$..', ZakatRate:  '2.5%', ZakatDue:'$..', name: 'total business receivable s as of zakat due date'},
    {Line : 7, category: 'Deductions', AmtVal: '$..A13', ZakatRate:  '2.5%', ZakatDue:'$..Z13', name: 'Outstanding Neccessary Debts'},
    {Line : 8, category: 'Deductions', AmtVal: '$..', ZakatRate:  '', ZakatDue:'$..Z14', name: 'Zakat paid in advance during the year'},
    {Line : 9, category: 'Deductions', AmtVal: '$..', ZakatRate:  '', ZakatDue:'$..Z15', name: 'Total deductions:[Z13 PLUS Z15]'}
